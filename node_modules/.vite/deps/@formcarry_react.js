...
// node_modules/@formcarry/react/dist/react.esm.js
...
function useForm(props) {
  var id = props.id, _props$debug = props.debug, debug = _props$debug === void 0 ? true : _props$debug, extraData = props.extraData;
  var _useState = (0, import_react.useState)(false), submitted = _useState[0], setSubmitted = _useState[1];
  var _useState2 = (0, import_react.useState)(false), submitting = _useState2[0], setSubmitting = _useState2[1];
  var _useState3 = (0, import_react.useState)(void 0), error = _useState3[0], setError = _useState3[1];
  var _useState4 = (0, import_react.useState)(), response = _useState4[0], setResponse = _useState4[1];
...
//# sourceMappingURL=@formcarry_react.js.map
